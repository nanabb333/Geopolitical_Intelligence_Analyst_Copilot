#!/usr/bin/env python3
"""Main V0.1 scenario intelligence CLI."""
...
try:
    from generate_brief import DEFAULT_EVENTS_PATH, DEFAULT_RETURNS_PATH, generate_brief
...
def run_scenario(
    ...
    """Generate and write a Markdown historical analog scenario brief."""
    brief = generate_brief(query, top_k=top_k, events_path=events_path, returns_path=returns_path)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the V0.1 geopolitical scenario intelligence workflow.")
